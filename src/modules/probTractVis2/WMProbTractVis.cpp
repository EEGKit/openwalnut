...
{
    // Generally, there are only two types of connectors available for your usage: WModuleInputData and WModuleOutputData and they can
...
//    m_possibleSelections->addItem( "Sausages", "With Sauerkraut.", template_wurst_xpm );
    ...
    m_hideButton = m_group2->addProperty( "(Un-)Hide Color", "Trigger Button Text.", WPVBaseTypes::PV_TRIGGER_READY,
                                          boost::bind( &WMProbTractVis::hideButtonPressed, this ) );
    ...
    // 2: register your own handler: m_active->getCondition()->subscribeSignal( boost::bind( &WMProbTractVis::myCustomActiveHandler, this ) );
...
void WMProbTractVis::SafeUpdateCallback::operator()( osg::Node* node, osg::NodeVisitor* nv )
{
...
void WMProbTractVis::TranslateCallback::operator()( osg::Node* node, osg::NodeVisitor* nv )
{
...
bool WMProbTractVis::StringLength::accept( boost::shared_ptr< WPropertyVariable< WPVBaseTypes::PV_STRING > > /* property */,
...
boost::shared_ptr< WPropertyVariable< WPVBaseTypes::PV_STRING >::PropertyConstraint > WMProbTractVis::StringLength::clone()
{
    ...
    return boost::shared_ptr< WPropertyVariable< WPVBaseTypes::PV_STRING >::PropertyConstraint >( new WMProbTractVis::StringLength( *this ) );
}

void WMProbTractVis::activate()
{
...
void WMProbTractVis::hideButtonPressed()
{
