...
private:
    ...
    public: // NOLINT
         ...
         */
        explicit SafeUpdateCallback( WMProbTractVis* module ): m_module( module ), m_initialUpdate( true )
        {
        };
    ...
    public: // NOLINT
         ...
         * \param module just set the creating module as pointer for later reference.
         */
        explicit TranslateCallback( WMProbTractVis* module ): m_module( module ), m_initialUpdate( true )
        {
        };
