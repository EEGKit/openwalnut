...
#ifndef OPENWALNUT_WMCONVERTERCSVDATATOFIBERS_H
#define OPENWALNUT_WMCONVERTERCSVDATATOFIBERS_H
 ...
 * \ingroup modules
 */
class WMConverterCSVdataToFibers : public WModule
{
public:
    /**
     * Standard constructor.
     */
    WMConverterCSVdataToFibers();

    /**
     * Destructor.
     */
    virtual ~WMConverterCSVdataToFibers();
...
private:
    ...
    boost::shared_ptr< WDataSetFibers> m_points;
...
#endif //OPENWALNUT_WMCONVERTERCSVDATATOFIBERS_H
