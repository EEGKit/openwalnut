    ...
    m_viewer( m_glDockWidget->getGLWidget()->getViewer() )
{
    ...
    m_imageConnection = m_viewer->getScreenCapture()->subscribeSignal( boost::bind( &WQtGLScreenCapture::handleImage, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3 ) );
}
