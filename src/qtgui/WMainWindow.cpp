...
{
    WProjectFile::SPtr proj( new WProjectFile( filename, boost::bind( &WMainWindow::slotLoadFinished, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3 ) ) );
    proj->load();
}
