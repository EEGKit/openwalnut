...
MACRO(_PCH_GET_COMPILE_FLAGS _out_compile_flags)
  ...
  GET_DIRECTORY_PROPERTY(_directory_flags_26 COMPILE_DEFINITIONS)
  #MESSAGE("_directory_flags_26 ${_directory_flags_26}" )
  LIST(APPEND ${_out_compile_flags} ${return_value})
  FOREACH(_def ${_directory_flags_26})
  	LIST(APPEND ${_out_compile_flags} "-D${_def}")
  ENDFOREACH(_def)
  LIST(APPEND ${_out_compile_flags} ${CMAKE_CXX_FLAGS} )
  
  SEPARATE_ARGUMENTS(${_out_compile_flags})
  #MESSAGE("${${_out_compile_flags}}")
  
  #MESSAGE("return_value1 = ${${_out_compile_flags}}")
  #SET(${_out_compile_flags} ${return_value})
  #MESSAGE("return_value2 = ${${_out_compile_flags}}")
...
MACRO(_PCH_GET_COMPILE_COMMAND out_command _input _output)
    ...
    #FOREACH(INCDIR ${_INCLUDE_DIRECTORIES})
    #	LIST(APPEND _inc_dirs "-I${INCDIR}")
    #ENDFOREACH(INCDIR)
...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input)
  ...
  TARGET_LINK_LIBRARIES( ${_targetName}_pch_dephelp ${${_targetName}_LIB_DEPENDS} )
  FILE(MAKE_DIRECTORY ${_outdir})

#  GET_TARGET_PROPERTY(_targetLibs ${_PCH_current_target} LIB_DEPEND )
#  MESSAGE("${_targetName} _targetLibs: ${OWcommon_LIB_DEPENDS}")
  #GET_TARGET_PROPERTY(_targetDefs ${_PCH_current_target} LINK_FLAGS )
#  GET_DIRECTORY_PROPERTY(_targetDefs VARIABLES)
#  MESSAGE("${_targetName} _targetDefs: ${_targetDefs}")
